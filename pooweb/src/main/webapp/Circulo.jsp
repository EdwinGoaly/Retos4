    ...
    <body>
        ...
        <div class="contenedor">
            <div class="figura-contenedor">
                <img class="figuras" src="https://pngimg.com/uploads/circle/circle_PNG4.png" alt=""></a>
                <div class="nombre">1.Círculo</div>
            </div>
            <div class="campos">
                <form action="figura" method="post">
                    <center><p>Área</p></center>
                    <label class="formulario" name="radio">Ingrese el valor del radio:</label>
                    <input class="formulario" type="number" name="radio" id="radio">
                    <br>
                    <button class="formulario" type="submit" name="control" value="areaci">Calcular</button>
                </form>
            </div>
            ...
            <div class="campos">
                <form action="figura" method="post">
                    ...
                    <label class="formulario" name="lado">Ingrese el diametro:</label>
