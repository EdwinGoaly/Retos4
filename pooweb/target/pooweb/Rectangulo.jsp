    ...
    <body>
        ...
        <div class="contenedor">
            <div class="figura-contenedor">
                <img class="figuras" src="https://www.imagensempng.com.br/wp-content/uploads/2021/06/05.png" alt=""></a>
                <div class="nombre">2.Rectángulo</div>
            </div>
            <div class="campos">
                <center><p>Área y Perímetro</p></center>
                <form action="figura" method="post">
                    <label class="formulario" >Ingrese el valor del largo:</label>
                    <input class="formulario" type="number" name="largo" id="largo">
                    <br>
                    <label class="formulario" >Ingrese el valor del ancho:</label>
                    <input class="formulario" type="number" name="ancho" id="ancho">
                    <br>
                    <button class="formulario" type="submit" name="control" value="areare">Calcular</button>
                </form>
            </div>
